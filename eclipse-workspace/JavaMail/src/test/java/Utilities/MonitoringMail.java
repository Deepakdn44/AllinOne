...
public class MonitoringMail
{
	...
	public void sendMail(String mailServer, String from, String[] to, String subject, String messageBody) throws MonitorSettingException, AccessException
	{
		boolean debug = false;
		...
		props.put("mail.debug", "true");
	     ...
	     props.setProperty("mail.smtp.socketFactory.port", "465"); 
		  ...
		  SMTPAuthenticator auth = new SMTPAuthenticator();
		    SSLSession session = Session.getDefaultInstance(props, auth);
